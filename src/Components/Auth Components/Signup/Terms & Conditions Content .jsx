...
export function Terms_and_Conditions() {
  return (
    <div className="p-6 space-y-6">
      ...
      <p>
        Welcome to <b>capchacode</b> (“Company”, “we”, “our”, “us”)!
      </p>
      <p>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at <b>capchacode.in</b> (together or individually
        “Service”) operated by <b>capchacode</b>.
      </p>
      <p>
      ...
      <p>
        ...
        <b>ankansahaofficial@gmail.com</b> so we can try to find a solution.
      ...
      <p>
        Content found on or through this Service are the property of capchacode
      ...
      <p>
        ...
        capchacode and its licensors. Service is protected by copyright,
      ...
      <p>
        ...
        to ankansahaofficial@gmail.com, with the subject line: “Copyright
      ...
      <p>
        You may provide us either directly at ankansahaofficial@gmail.com or via
      ...
      <p>
        ...
        are not owned or controlled by capchacode.
      </p>
      <p>
        capchacode has no control over, and assumes no responsibility for the
      ...
      <p>
        ...
        email: <b>ankansahaofficial@gmail.com</b>.
      </p>
    </div>
  );
}
